...
class VendorOfferForm(forms.ModelForm):
    ...
    def __init__(self, vendor_id=None, **kwargs):
        ...
        if vendor_id:
            self.fields['vendor_name'].queryset = Vendors.objects.filter(vendor_id=vendor_id)
        for field in self.fields:
            self.fields[field].widget.attrs['class'] = 'form-control'
...
class ProductOfferForm(forms.ModelForm):
    ...
    def __init__(self,vendor_id=None, **kwargs):
        ...
        if vendor_id:
            self.fields['product_name'].queryset = product.objects.filter(vendor_id=vendor_id)
        for field in self.fields:
            self.fields[field].widget.attrs['class'] = 'form-control'
...
class VariationOfferForm(forms.ModelForm):
    ...
    def __init__(self,vendor_id= None, **kwargs):
        ...
        if vendor_id:
            self.fields['variation_name'].queryset = Variation.objects.filter(product__vendor_id=vendor_id)
        for field in self.fields:
            self.fields[field].widget.attrs['class'] = 'form-control'
