...
urlpatterns = [
    ...
    path(
        "activate_varient/<id>",
        views.activate_varient,
        name="activate_varient",
    ),
    ...
    path(
        "edit_varient_offers/<id>",
        views.edit_varient_offers,
        name="edit_varient_offers",
    ),
    path(
        "edit_product_offers/<id>",
        views.edit_product_offers,
        name="edit_product_offers",
    ),
    path(
        "edit_vendor_offers/<id>",
        views.edit_vendor_offers,
        name="edit_vendor_offers",
    ),
    path(
        "delete_product_offer/<id>",
        views.delete_product_offer,
        name="delete_product_offer",
    ),
    path(
        "delete_variation_offer/<id>",
        views.delete_variation_offer,
        name="delete_variation_offer",
    ),
    path(
        "activate_product_offer/<id>",
        views.activate_product_offer,
        name="activate_product_offer",
    ),
    path(
        "activate_variation_offer/<id>",
        views.activate_variation_offer,
    ...
    path(
        "add_variation_offer",
        views.add_variation_offer,
        name="add_variation_offer",
    ),
    # report generation
    ...
    path(
        "order_delivered/<id>", views.order_delivered, name="order_delivered"
    ),
    path(
        "order_cancelled/<id>", views.order_cancelled, name="order_cancelled"
    ),
