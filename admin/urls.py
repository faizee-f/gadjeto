...
urlpatterns = [
    ...
    path(
        "reject_vendor/<vendor_id>", views.reject_vendor, name="reject_vendor"
    ),
    path(
        "user_block_unblock/<customer_id>",
        views.user_block_unblock,
        name="user_block_unblock",
    ),
    path("coupon_list/", views.coupon_list, name="coupon_list"),
    path("edit_coupon/<int:id>", views.edit_coupon, name="edit_coupon"),
    path(
        "activate_coupen/<id>", views.activate_coupen, name="activate_coupen"
    ),
